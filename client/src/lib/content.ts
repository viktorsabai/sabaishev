...
export const content: Record<Language, any> = {
  ru: {
    ...
    hero: {
      ...
      quickLinks: [
        { label: "Новый продукт", stage: 3 },
        { label: "AI-фича", stage: 6 },
        { label: "Мобильное приложение", stage: 7 },
        { label: "Web-продукт", stage: 5 },
        { label: "Автоматизация", stage: 8 },
        { label: "Редизайн", stage: 4 },
        { label: "MVP", stage: 7 },
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "I turn ideas, complex workflows and AI features into working products — from first logic to launch.",
      tags: ["New product", "AI feature", "Mobile app", "Web product", "Automation", "Redesign"],
      quickLinks: [
        { label: "New product", stage: 3 },
        { label: "AI feature", stage: 6 },
        { label: "Mobile app", stage: 7 },
        { label: "Web product", stage: 5 },
        { label: "Automation", stage: 8 },
        { label: "Redesign", stage: 4 },
        { label: "MVP", stage: 7 },
        { label: "Complex workflow", stage: 1 },
      ],
      cta: {
  ...
  th: {
    ...
    hero: {
      ...
      subtitle: "เปลี่ยนไอเดีย เวิร์กโฟลว์ที่ซับซ้อน และฟีเจอร์ AI ให้เป็นผลิตภัณฑ์ที่ใช้งานได้ ตั้งแต่ตรรกะแรกจนถึงการเปิดตัว",
      tags: ["ผลิตภัณฑ์ใหม่", "ฟีเจอร์ AI", "แอปมือถือ", "ผลิตภัณฑ์เว็บ", "อัตโนมัติ", "รีดีไซน์"],
      quickLinks: [
        { label: "ผลิตภัณฑ์ใหม่", stage: 3 },
        { label: "ฟีเจอร์ AI", stage: 6 },
        { label: "แอปมือถือ", stage: 7 },
        { label: "ผลิตภัณฑ์เว็บ", stage: 5 },
        { label: "อัตโนมัติ", stage: 8 },
        { label: "รีดีไซน์", stage: 4 },
        { label: "MVP", stage: 7 },
        { label: "เวิร์กโฟลว์ซับซ้อน", stage: 1 },
      ],
      cta: {
        explore: "ดูผลิตภัณฑ์",
        contact: "ติดต่อ",
